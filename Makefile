...
# Generated by qmake (2.01a) (Qt 4.8.3) on: Sat Oct 6 10:00:37 2012
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/passwords1.0.0/ && $(COPY_FILE) --parents encryption.h databases.h gui/mainWindow.h gui/setPasswordDialog.h .tmp/passwords1.0.0/ && $(COPY_FILE) --parents encryption.cpp databases.cpp main.cpp gui/mainWindow.cpp gui/setPasswordDialog.cpp .tmp/passwords1.0.0/ && $(COPY_FILE) --parents gui/mainWindow.ui gui/setPasswordDialog.ui .tmp/passwords1.0.0/ && (cd `dirname .tmp/passwords1.0.0` && $(TAR) passwords1.0.0.tar passwords1.0.0 && $(COMPRESS) passwords1.0.0.tar) && $(MOVE) `dirname .tmp/passwords1.0.0`/passwords1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/passwords1.0.0
...
databases.o: databases.cpp databases.h
